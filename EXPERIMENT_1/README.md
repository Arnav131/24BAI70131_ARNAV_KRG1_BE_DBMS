...
- Apply CHECK constraint to ensure visitors are at least 18 years old
...
VALUES(501, 'Arnav Prajapati', 20, 'arnav@gmail.com')

INSERT INTO LIBRARY_VISITORS VALUES(502, 'Anshu Sharma', 19, 'anshu@gmail.com')
```
- Execute both insert statements
- Ensure data satisfies all constraints (AGE >= 18, unique EMAIL, etc.)
