...
```
    ...
    (101, 'ARNAV', 'Male', 30000),
    (102, 'RIYA', 'Female', 55000),
    (103, 'MUSKAN', 'Female', 45000),
    (104, 'ANUJ', 'Male', 59000),
    (105, 'ANANYA', 'Female', 66000);
...
```
    ...
    FROM employees WHERE gender = IN_GENDER;
        STATUS:='SUCCESS';
    END;
    $$ LANGUAGE PLPGSQL;
    DO
    ...
    STATUS VARCHAR:='PENDING';
    BEGIN
    CALLget_employee_count_by_gender(GEN, COUNT_OF_EMPLOYEES, STATUS);
    RAISE NOTICE 'COUNT OF % EMPLOYEES IS % AND STATUS IS %', GEN, COUNT_OF_EMPLOYEES, STATUS;
    END;
    $$
